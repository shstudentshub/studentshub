...
<html>
			...
			<nav class="custom-navbar">
				<section class="nav-wrapper">
					...
					<ul class="side-nav dashboard-side-nav-sm" id="nav-mobile">
						...
						<li class="selected-item"><a href="posts.php" class="selected">My Posts<span class="allBadge"></span></a></li>
						<li><a href="review.php">View Pending Items<span class="badge"></span></a></li>
						<li><a href="approve.php">View Approve Items<span class="appBadge"></span></a></li>
    ...
    <div class="search-sm-div" style="padding-bottom:50px">
    </div>
		...
		<section class="row dashboard-div">
			<section class="row">
				...
				<section class="col m2 l2 dashboard-side-div hide-on-med-and-down">
					...
					<li class="selected-item"><a href="posts.php"><i class="fa fa-tags"></i> My Posts<i class="allBadge"></i></a></li>
