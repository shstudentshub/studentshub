...
<html>
	...
	<body>
		...
		<section id="mySidenav" class="sidenav">
			...
			<li class="selected-item"><a href="profile" class="selected"><i class="fa fa-user"></i>&nbsp; My Profile</a></li>
					...
					<section class='row'>
						<section class='col-md-4'></section>
							<section class='col-md-4'>
								<section class='user-profile-div alert'>
									<h4 class='text-center'>User Profile</h4>
									<h1 class='text-center'><i class='fa fa-user'></i></h1>
									<table class="table table-sm">
								        <tbody>
								          <tr>
								            <td class='text-left'><small><b>Full Name:</b></small></td>
								            <td class='text-right'><small><?php echo $userFullname ?></small></td>
								          </tr>
								          <tr>
								            <td class='text-left'><small><b>Contact Number:</b></small></td>
								            <td class='text-right'><small><?php echo $userContact ?></small></td>
								          </tr>
								          <tr>
								            <td class='text-left'><small><b>You sign up on:</b></small></td>
								            <td class='text-right'><small><?php echo $userSignUpdate ?></small></td>
								          </tr>
                          					<tr>
								            <td class='text-left'><small><b>City :</b></small></td>
								            <td class='text-right'><small><?php echo $city ?></small></td>
								          </tr>
                          					<tr>
								            <td class='text-left'><small><b>Country:</b></small></td>
								            <td class='text-right'><small><?php echo $country ?></small></td>
								          </tr>
								        </tbody>
								      </table>
								      <p class='text-center'><a href='account-setup'>Edit Profile</a></p>
								</section>
							</section>
						<section class='col-md-4'></section>
					</section>
