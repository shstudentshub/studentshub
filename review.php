			...
			<nav class="custom-navbar">
				<section class="nav-wrapper">
					...
					<ul class="side-nav dashboard-side-nav-sm" id="nav-mobile">
						...
						<li class="selected-item"><a href="review.php" class="selected">View Pending Items<span class="badge"></span></a></li>
		...
		<section class="row dashboard-div">
			<section class="row">
				...
				<section class="col m2 l2 dashboard-side-div hide-on-med-and-down">
					...
					<li class="selected-item"><a href="review.php"><i class="fa fa-hourglass"></i> Pending Items<i class="badge"></i></a></li>
