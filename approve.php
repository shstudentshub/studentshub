			...
			<nav class="custom-navbar">
				<section class="nav-wrapper">
					...
					<ul class="side-nav dashboard-side-nav-sm" id="nav-mobile">
						...
						<li class="selected-item"><a href="approve.php" class="selected">View Approved Items</a></li>
						<li><a href="approve.php">View Declined Items</a></li>
		...
		<section class="row dashboard-div">
			<section class="row">
				...
				<section class="col m2 l2 dashboard-side-div hide-on-med-and-down">
					...
					<li><a href="posts.php"><i class="fa fa-tags"></i> Posts</a></li>
					<li><a href="review.php"><i class="fa fa-hourglass"></i> View Pending Items</a></li>
					<li class="selected-item"><a href="approve.php" class="selected"><i class="fa fa-check"></i> View Approved Items</a></li>
				...
				<section class="col s12 m10 l10">
					<h3>Approve items comes here</h3>
				</section>
