			...
			<nav class="custom-navbar">
				<section class="nav-wrapper">
					...
					<ul class="side-nav dashboard-side-nav-sm" id="nav-mobile">
						...
						<li class="selected-item"><a href="review.php" class="selected">View Pending Items</a></li>
		...
		<section class="row dashboard-div">
			<section class="row">
				...
				<section class="col m2 l2 dashboard-side-div hide-on-med-and-down">
					...
					<li class="selected-item"><a href="review.php" class="selected"><i class="fa fa-tags"></i> View Pending Items</a></li>
					<li><a href="approve.php"><i class="fa fa-cog"></i> View Approve Items</a></li>
