	...
	<body>
		...
		<section class="navbar-fixed">
          ...
          <ul class="right hide-on-large-only">
            <li><a href="#!" class="show-on-medium-and-up">Live Chat</a></li>

          </ul>
					<ul class="side-nav" id="nav-mobile">
						<section class="side-nav-profile-div">
							<img src="./../assets/img/students-hub-logo.png" class="side-nav-profile-img" alt="Logo">
							<span class="side-nav-profile-name">Student Hub</span>
						</section>
            <li><a href="#!">Need Help ?</a></li>
            <li><a href="#!">FAQ</a></li>
            <li><a href="#!">Contact</a></li>
