<?php 
	...
	$getQuery = "SELECT MONTH(item_post_date) AS post_month,YEAR(item_post_date) AS post_year, count(*) AS post_number FROM items WHERE item_publisher_id = $publisherId GROUP BY MONTH(item_post_date)";
