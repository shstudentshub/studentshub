		...
		while ($row = $result->fetch_assoc()) {
			...
			echo "
				<tr>
					...
					<td>
						<i class='fa fa-edit user-item-action-icon edit-icon' onclick='editItem($itemObj)'></i>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<i class='fa fa-trash-o user-item-action-icon delete-icon' onclick='deleteItem($itemObj)'></i>
					</td>
				</tr>
			";
